# stage1-fixed.v1 / observation.v1 / unguided-pair.v1
...
識別特徴が足りなければinsufficient_discriminative_features:trueと非空のinsufficiency_reasons配列、そうでなければfalseと[]を必ず返します。内部状態、工具の型番、停止原因、意図、不明を推測で埋めないでください。指定JSONだけを返してください。
